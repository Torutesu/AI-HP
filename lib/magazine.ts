...
const rawArticles: Article[] = [
  ...
  },
  {
    ...
    related: ["ai-roi-calculation", "inhouse-vs-saas", "saas-cost-one-third", "ai-subsidy-guide"],
    category: "コスト削減",
  ...
  },
  {
    ...
    related: ["dx-vs-ai", "back-office-automation", "ai-agent-autonomy", "application-layer-cases"],
    category: "技術トレンド",
  ...
  },
  {
    ...
    related: ["hallucination-control", "ai-agent-autonomy", "ai-adoption-steps", "open-models-tracking"],
    category: "技術トレンド",
  ...
  },
  {
    ...
    related: ["chatgpt-business-start", "ai-timeline", "poc-to-results", "ai-adoption-failures", "ai-cost-benchmark"],
    category: "経営・組織",
  ...
  },
  {
    ...
    related: ["recruiting-ai", "back-office-automation", "manufacturing-estimate", "ai-data-security"],
    category: "事例・シナリオ",
  ...
  },
  {
    ...
    related: ["chatbot-support", "sales-ai-win-rate", "back-office-automation", "healthcare-backoffice-ai"],
    category: "事例・シナリオ",
  ...
  },
  {
    ...
    updatedAt: "2026.07.18",
    excerpt:
      "汎用SaaSの固定費が下がらない構造（席数課金・機能過剰・分散契約）と、内製で1/3を目指す考え方を解説。開発済みモジュールとオープン技術の活用、残すか置き換えるかの見極めまでまとめます。",
    body: [
  ...
  },
  {
    ...
    updatedAt: "2026.07.18",
    excerpt:
      "営業支援AIで商談の勝率を上げる3つの実装パターン（商談分析・提案書自動生成・顧客ランキング）を、導入の順序・つまずき・判断基準まで具体的に解説。勝てる商談に資源を集中させます。",
    body: [
  ...
  },
  {
    ...
    related: ["construction-ai", "back-office-automation", "professional-services-ai", "poc-to-results"],
    category: "事例・シナリオ",
  ...
  },
  {
    ...
    related: ["ai-kpi-design", "ai-proposal-approval", "poc-to-results", "license-audit", "ai-adoption-steps"],
    category: "経営・組織",
  ...
  },
  {
    ...
    related: ["logistics-ai", "manufacturing-estimate", "healthcare-backoffice-ai", "ai-adoption-steps"],
    category: "事例・シナリオ",
  ...
  },
  {
    ...
    category: "経営・組織",
    title: "AI Native企業への移行と現場定着の組織設計",
    date: "2026.06.12",
    image: "/img/company/position.jpg",
    updatedAt: "2026.07.18",
    excerpt:
